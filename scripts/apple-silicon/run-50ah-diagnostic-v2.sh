...
RUN_DIR="benchmark-runs/50AH-native-tri-depth-pgr2-v2"
mkdir -p "$RUN_DIR"
...
# 50AH v2: enable native triangle-depth + diagnostic logging for sibling sync
XEMU_NATIVE_TRI_DEPTH=1 \
XEMU_METAL_DIAG_DEPTH_STATS=1 \
XEMU_METAL_DIAG_DEPTH_SYNC=1 \
