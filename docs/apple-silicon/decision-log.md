...
## 2026-05-24 (cycle 41a `PAGE_NOCACHE` allocation-flag variation — CLOSED on `apple-silicon-performance`): OUTCOME G0(c) PERSISTS under `PAGE_NOCACHE`; cache-policy candidate #1 eliminated; cycle 41b explores `PAGE_WRITECOMBINE`
